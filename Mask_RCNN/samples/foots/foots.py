...
def train(model):
    """Train the model."""
    # Training dataset.
    dataset_train = FootsDataset()
    dataset_train.load_foots(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = FootsDataset()
    dataset_val.load_foots(args.dataset, "val")
    dataset_val.prepare()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', required=False,
                        metavar="/path/to/foots/dataset/",
                        help='Directory of the foots dataset')
    ...
    if args.command == "train":
        ...
        class InferenceConfig(FootsConfig):
