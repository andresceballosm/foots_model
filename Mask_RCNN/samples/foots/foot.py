...
class BalloonConfig(Config):
    ...
    NUM_CLASSES = 1 + 2  # Background + right feet and left feet
...
class BalloonDataset(utils.Dataset):
    ...
    def load_balloon(self, dataset_dir, subset):
        ...
        self.add_class("foot", 1, "left_feet") #adjusted here
        self.add_class("foot", 2, "right_feet") #adjusted here
        ...
        for a in annotations:
            ...
            class_names_str  = [r['region_attributes']['feet'] for r in a['regions'].values()]
            class_name_nums = []
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        if image_info["source"] != "foot": #adjusted here
    ...
    def image_reference(self, image_id):
        ...
        info = self.image_info[image_id]
        if info["source"] == "foot": #adjusted here
            return info["path"]
        else:
